...
workflow sarscov2_lineages {
    ...
    call sarscov2__nextclade_one_sample as nextclade_one_sample {
    	input:
    		genome_fasta = genome_fasta
    }

    call sarscov2__pangolin_one_sample as pangolin_one_sample {
    	input:
    		genome_fasta = genome_fasta
    }
...
task sarscov2__nextclade_one_sample {
    meta {
...
task sarscov2__pangolin_one_sample {
    meta {
